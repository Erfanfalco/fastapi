...
transaction_cube_query = '''INSERT INTO "brokerCube".transaction_cube (branch_name, total_amount, date, is_a_purchase, stock_code) VALUES (%s, %s, %s, %s, %s) ;'''


checking_date_transaction_cube = '''SELECT * FROM "brokerCube".transaction_cube WHERE date = '{0}';'''


updating_amount_transaction_cube = '''UPDATE "brokerCube".transaction_cube SET total_amount = '{0}' WHERE date = '{1}';'''

creating_transaction_cube = ('''CREATE TABLE IF NOT EXISTS "brokerCube".transaction_cube ( 
                    branch_name text NULL,
                    is_a_purchase bool NULL, 
